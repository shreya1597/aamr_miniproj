...
def get_laser_scan(msg):
    global safe_distance, new_list, bot_theta, bot_x_pos, bot_y_pos, state, switch_las
...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        global time_window, bot_theta, bot_x_pos, bot_y_pos, dist_to_goal, new_list, X, Y, count, cn, state 
